...
final class SidebarComponentTest extends TestCase
{
    public function testTheContractDeclaresBrandHomeActiveAndItems(): void
    {
        ...
        self::assertSame(['brand', 'home', 'wordmark', 'active', 'items', 'versions', 'versionsHref', 'versionsRest'], array_keys($contract->propsSchema));
    ...
    public function testMountGroupsTheItemsAndKeepsBrandHomeAndActive(): void
    {
        ...
        self::assertSame(['brand' => 'Milpa Admin', 'home' => '/milpa/admin', 'wordmark' => '', 'groups' => [], 'versions' => [], 'versionsHref' => '', 'versionsRest' => 0], $bare->meta, 'the defaults — a panel that could not read its lock names no version rather than guessing one');
