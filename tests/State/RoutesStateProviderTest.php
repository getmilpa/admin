...
/**
 * `RoutesStateProvider` mapea las rutas de la tabla canónica ({@see \Milpa\Admin\Contracts\RouteTableSource::routes()},
...
final class RoutesStateProviderTest extends TestCase
{
    ...
    {
        self::assertInstanceOf(AdminSectionStateProvider::class, new RoutesStateProvider([]));
    }
