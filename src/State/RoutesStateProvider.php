...
/**
 * El `AdminSectionStateProvider` de la sección "Sistema": mapea las rutas de la tabla canónica
 * ({@see \Milpa\Admin\Contracts\RouteTableSource::routes()}) a filas de display
 ...
 */
final class RoutesStateProvider implements AdminSectionStateProvider
{
