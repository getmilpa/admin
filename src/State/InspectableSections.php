...
{
    /** @var ?list<array{id: string, title: string, href: string, provider: AdminSectionStateProvider}> */
     ...
     *
     * @return list<array{id: string, title: string, href: string, provider: AdminSectionStateProvider}>
     */
    public function all(): array
    {
        ...
        $sections = [];
        foreach ((new AdminSectionStateDiscovery($this->plugins))->all() as $id => $provider) {
            $sections[] = [
                'id' => $id,
     ...
     *
     * @return array{id: string, title: string, href: string, provider: AdminSectionStateProvider}|null
     */
